...
<div id = "oseappcontainer">
  <div class="container">
    ...
    <div id ="container-left">
        ...
        <div id ="safe-browsing">
        <h3><?php echo SYSTEM_SECURITY_AUDIT; ?></h3>
	     <?php 
	    ...
	    <div id ="audit-list">
        <h3><?php echo SECURITY_CONFIG_AUDIT; ?></h3>
	    <?php 
	...
	<div id = "container-right">
      ...
      <?php 
      	...
      	{
      		echo '<div style="padding: 10px 0px;"><i class="icon-wordpress" style="color: #666; margin-right: 5px; "></i><a href = "http://wordpress.org/support/view/plugin-reviews/ose-firewall" target="_blank">Give our plugin a review</a></div>';		
      	}
      ?>
    </div>
  </div>
