...
* @subpackage    Open Source Excellence Anti-Brute Force Plugin
* @author        Open Source Excellence {@link http://www.opensource-excellence.com}
* @author        Protect Website {@link http://www.protect-website.com}
* @author        Henrik Schack {@link http://henrik.schack.dk/google-authenticator-for-wordpress} 
* @author        Created on 25-Jul-2013
* @license GNU/GPL http://www.gnu.org/copyleft/gpl.html
* @original_plugin_url http://henrik.schack.dk/google-authenticator-for-wordpress
*
*
...
----------------------------------------------------------------------------
   This class is re-written by Protect Website, and credits to the following authors	
...
class GoogleAuthenticator {
	private static $instance; // to store a reference to the plugin, allows other plugins to remove actions
	...
	function init() {
		...
		if (defined ( 'DOING_AJAX' ) && DOING_AJAX)
			add_action ( 'wp_ajax_GoogleAuthenticator_action', array (
				$this,	'ajax_callback'	) );
		
		add_action ( 'personal_options_update', array (
				$this,	'personal_options_update' 
		) );
		add_action ( 'profile_personal_options', array (
				$this,  'profile_personal_options' 
		) );
		add_action ( 'edit_user_profile', array (
				$this,	'edit_user_profile' 
		) );
		add_action ( 'edit_user_profile_update', array (
				$this,	'edit_user_profile_update' 
		) );
	}
	...
	function profile_personal_options() {
		...
		if ('' == $GA_description) {
			$GA_description = __ ( str_replace(" ","",get_bloginfo('name')), 'google-authenticator' );
		}
