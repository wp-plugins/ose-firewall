...
class CountryblockController extends BaseController {
	...
	public function actionChangeAllCountry() {
		...
		if ($result==true)
		{
				oseAjax::aJaxReturn(true, 'SUCCESS', oLang::_get("The country status is updated successfully."), false);
		} 
		else
		{
				oseAjax::aJaxReturn(false, 'ERROR', oLang::_get("Failed updating the country status."), false);
		}
	}
}
?>	