...
oseATHIPMANAGER.panel = Ext.create('Ext.grid.Panel', {
	    ...
	    columns: [
            ...
            ,{id: 'datetime', header: O_DATE,  hidden:false, dataIndex: 'datetime',width: 150, sortable: true}
            ,{id: 'name', header: O_IP_RULE_TITLE,  hidden:false, dataIndex: 'name', width: 150,  sortable: true}
            ,{id: 'score', header: O_RISK_SCORE,  hidden:false, dataIndex: 'score', width: 80, sortable: true}
            ,{id: 'ip32_start', header: O_START_IP,  hidden:false, dataIndex: 'ip32_start', width: 150, sortable: true}
            ,{id: 'ip32_end', header: O_END_IP,  hidden:false, dataIndex: 'ip32_end', width: 150, sortable: true}
            ...
            ,{id: 'host', header: O_HOST,  hidden:false, dataIndex: 'host', width: '18%', sortable: true}
            ,{id: 'visits', header: O_VISITS,  hidden:false, width: 40, dataIndex: 'visits', sortable: false}
            ,{id: 'view', header: O_VIEWDETAIL,  hidden:false, width: 40, dataIndex: 'view', sortable: false}
	    ],
