...
define('SUBSCRIPTION_DESCRIPTION1', 'Du skal blot oprette en konto ved hj&aelig;lp af formularen i h&oslash;jre side nedenfor, eller hvis du har en konto hos Gabemedia allerede, blot logge p&aring ved hj&aelig;lp af formularen i venstre side nedenfor. <br/> Vi tilbyder 60 dage 100% tilfredshedsgaranti, hvis du ikke er tilfreds, udsteder vi fuld refusion til dig uden at stille sp&oslash;rgsm&aring;l.');
...
define('REGISTERED_ACCOUNT_DESC', 'Hvis du allerede har en konto, skal du indtaste din <code> Gabemedia </code> Kontooplysninger');
define('CENTRORA', 'Gabemedia Security');
...
define('CALL_TO_ACTION_UL', '<li>Vi har hjulpet tusindvis af kunder til at beskytte og rense deres hjemmesider siden 2009, hvis du har brug for hj&aelig;lp til at beskytte eller reng&oslash;ring virus p&aring; din hjemmeside, er du velkommen til at <a href="mailto:salg@gabemedia.net" target="_blank"><span class="strong">Kontakte os</span></a>.</li>
					<li>Med Gabemedia Security, har den <span class="strong">Grundl&aelig;ggendefirewall</span> allerede hjulpet dig med at blokere <b>99%</b> systematisk hacking og sikre, at din kunde data er sikret. Hvis du har brug for et <span class="strong">ekstra lag af beskyttelse</span> med de avancerede firewall regler, er du velkommen til at tegne et abonnement plan for at f&aring; den beskyttelse, aktiveret.</li>
					<li>N&aring;r du har mistanke om din hjemmeside er inficeret af ondsindede koder, kan Gabemedia Security virus scanner hj&aelig;lpe dig med at s&oslash;ge efter virus indenfor f&aring; minutter. Scanneren vil blive aktiveret, n&aring;r abonnementet aktiveres.</li>
...
define('CALL_TO_ACTION_DESC2', 'Hvorfor ikke blive vores partner ved at henvise Gabemedia Security til andre virksomheder og kunder. ');
...
define('AUTHENTICATION_DESC', 'For at aktivere cloud backup bedes bemyndige Gabemedia Security til din foretrukne cloud-tjeneste.');
