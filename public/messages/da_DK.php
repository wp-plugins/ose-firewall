...
define('OSE_WORDPRESS_FIREWALL_SETTING_DESC', 'Gabemedia Security er en Web Application Firewall til Wordpress oprettet af <a href="http://www.gabemedia.dk" target="_blank">Beskyt din hjemmeside</a>. Den beskytter dit websted mod angreb og hacking fors�g effektivt.');
define('OSE_WORDPRESS_FIREWALL_UPDATE_DESC', 'Gabemedia Security er en Web Application Firewall til Wordpress oprettet af <a href="http://www.gabemedia.dk" target="_blank">Beskyt din hjemmeside</a>. Den beskytter dit websted mod angreb og hacking fors�g effektivt.');
...
define('BLOCK_QUERY_LONGER_THAN_255CHAR', 'Bloker foresp�rgsler l�ngere end 255 tegn');
...
define('TEST_CONFIGURATION', 'Test din ops�tning');
define('TEST_CONFIGURATION_NOW', 'Test din ops�tning nu!');
define('SAVE_CHANGES', 'Gem �ndringer');
...
define('FOUNDQUERY_LONGER_THAN_255CHAR', 'Fundet foresp�rgsler l�ngere end 255 tegn');
...
define('SERVERIP','Din ip adresse (at undg� falske alarmer p� grund af tom user agent)');
...
define('START_NEW_VIRUSSCAN','Start ny Multi-tr�ds Scan');
define('CONT_VIRUSSCAN','Continue Multi-Threads Scan');
define('START_NEW_SING_VIRUSSCAN','Start ny single-Tr�d Scan');
...
define('OSE_VIRUS_SCAN_DESC','Gabemedia Security virus scaner har til form�l at scanne og rense WordPress ondsindede koder og overv�ger din hjemmeside p� en 24/7 basis.');
define('CUSTOM_BANNING_MESSAGE','Tilpasset banned besked');
define('FILEEXTSCANNED','Fil extensions, bliver scannet');
define('DONOTSCAN','Scan ikke filer st�rre end (Enhed: Megabytes)');
define('PLEASE_CHOOSE_OPTION','V�lg en mulighed');
define('COMPATIBILITY','Kompatibilitet');
define('OSE_PLEASE_CONFIG_FIREWALL','Venligst konfigurere firewallens indstillingen her .');	
define('OSE_FOLLOWUS','F�lg os at holde sig opdateret.');
define('OSE_ID_INFO','Gabemedia Security konto informaiton (Venligst kun udfylde din konto, n�r du er en avanceret / professionelt).');	
