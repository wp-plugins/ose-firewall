...
define('OSE_WORDPRESS_FIREWALL_SETTING_DESC', ''.OSE_WORDPRESS_FIREWALL.' er en Web Application Firewall til Wordpress oprettet af <a href="http://www.gabemedia.dk" target="_blank">Beskyt din hjemmeside</a>. Den beskytter dit websted mod angreb og hacking fors&oslash;g effektivt.');
define('OSE_WORDPRESS_FIREWALL_UPDATE_DESC', ''.OSE_WORDPRESS_FIREWALL.' er en Web Application Firewall til Wordpress oprettet af <a href="http://www.gabemedia.dk" target="_blank">Beskyt din hjemmeside</a>. Den beskytter dit websted mod angreb og hacking fors&oslash;g effektivt.');
...
define('OSE_SUITE_PATH','Absolut sti af '.OSE_WORDPRESS_FIREWALL.' <br/>e.g. /home/youraccount/public_html/yoursite/ <br/> (Kontroller, at du har installeret <a href ="https://www.gabemedia.net" target="_blank">vores plugin</a>)');
