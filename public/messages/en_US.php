...
define('MANAGERULESETS_TITLE','Firewall <span>Settings</span>');
...
define('MANAGE_AD_RULESETS_TITLE','Advance Firewall Settings');
...
define('ANTISPAM_CONFIGURATION_TITLE','Anti-Spam <span>Configuration</span>');
...
define('ANTIVIRUS_CONFIGURATION_TITLE','Virus Scanner <span>Configuration</span>');
...
define('ANTIVIRUS_TITLE','Virus <span>Scanner</span>');
...
define('SCANREPORT_TITLE','Scan <span>Report</span>');
...
define('VARIABLES_TITLE','Variables <span>Management</span>');
...
define('COUNTRYBLOCK_TITLE', 'Country <span>Block</span>');
define('COUNTRYBLOCK_DESC','The Panel to Block IPs from countries');
define('COUNTRYBLOCK', 'Country Block');
define('BACKUP', 'Backup');
define('BACKUP_TITLE', 'Backup Management');
...
define('IPMANAGEMENT_INTRO', 'Block, Manage and Control the access of IP addresses. Centrora Plugin automatically detect suspicious IP for you and set as monitored as default.');
define('FIREWALL_SETTING_INTRO', 'Activate or Deactivate the firewall function. You can limit the security features of Centrora Plugin by deactivating any security function. We highly recommend to activate all of the security functions to carry the best out of Centrora Plugin');
define('VARIABLES_INTRO', 'Variable scanning. Centrora Plugin automatically scan the variables in the background to prevent attacks through variables');
define('VIRUS_SCANNER_INTRO', 'Virus Scanner is a powerful malware detector, it acts like a antivirus but is more powerful than a antivirus. It scans through every single files on your server or any specific path of files for virus, malware, spam, malicious codes, SQL injection, security vulnerabilities etc');
define('SCAN_REPORT_INTRO', 'Display the infected files last scanned by the virus scanner');
define('CONFIGURATION_INTRO', 'Configure the default settings of Centrora Plugin to best suit your personal needs. It includes settings for scanning, virus scanner, SEO, anti-spam, email, and admin email mapping');
define('BACK_UP_INTRO', 'Backup files and database into your own server for free. Dropbox & Google Drive available only for premium users');
...
define('CONFIG_SAVECOUNTRYBLOCK_FAILE', 'Save Country Block config failed, Country Block Database is not ready.');
