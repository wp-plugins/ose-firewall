...
//Start here;
define('OSE_WORDPRESS_FIREWALL', 'OSE Firewall<sup>&reg;</sup>');
define('OSE_WORDPRESS_FIREWALL_SETTING', 'OSE Firewall<sup>&reg;</sup>  Einstellungen');
define('OSE_WORDPRESS_FIREWALL_SETTING_DESC', 'OSE Firewall<sup>&reg;</sup> ist eine Web Application Firewall für Wordpress - entwickelt von <a href="http://www.protect-website.com" target="_blank">Protect Website</a>. Effektiver Schutz deiner Webseite  gegen Angriffe und Hacking-Versuche.');
...
define('CONFIGURATION','OSE Konfiguration');
