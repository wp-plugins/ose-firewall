...
//Start here;
define('OSE_WORDPRESS_FIREWALL', 'Centrora Security<sup>&reg;</sup>');
define('OSE_WORDPRESS_FIREWALL_SETTING', 'Centrora Security<sup>&reg;</sup>  Einstellungen');
define('OSE_WORDPRESS_FIREWALL_SETTING_DESC', 'Centrora Security<sup>&reg;</sup> ist eine Web Application Firewall für Wordpress - entwickelt von <a href="http://www.protect-website.com" target="_blank">Protect Website</a>. Effektiver Schutz deiner Webseite  gegen Angriffe und Hacking-Versuche.');
...
define('OSE_WORDPRESS_FIREWALL_CONFIG','Centrora Security™ Konfiguration');
...
define('STOP_DB_INIT','Aktion anhalten');
define('START_NEW_VIRUSSCAN','Neuen Scan starten');
define('CONT_VIRUSSCAN','Scan fortsetzten');
define('OSE_SCANNED','Centrora Security hat gescannt');
...
define('OSE_FIREWALL_ONLY','Nur durch Centrora Security geschützt');
define('OSE_SECSUITE_ONLY','Nur durch OSE Security Suite geschützt');
define('OSE_FWANDSUITE','Durch Centrora Security & OSE Security Suite geschützt');
...
define('OSE_ENABLE_SFSPAM','Forum Spam Stopp aktivieren');
define('OSE_YES','Ja');
define('OSE_NO','Nein');
define('OSE_SFSPAM_API','Forum Spam Stopp API Key');
define('SFSPAMIP','Spam Stopp IP');
...
define('DASHBOARD_TITLE','<span>OSE</span> Firewall<sup>&reg;</sup> ');
...
define('MANAGEIPS_DESC','Übersichtliche Verwaltung von IP-Adressen');
...
define('RULESETS','Regeln verwalten');
define('MANAGERULESETS_TITLE','Regel-<span>Verwaltung</span>');
define('MANAGERULESETS_DESC','Übersichtliche Verwaltung von Regeln der Firewall');
define('ITEM_STATUS_CHANGED_SUCCESS','Der Status der Regel wurde erfolgreich geändert.');
define('ITEM_STATUS_CHANGED_FAILED','Der Status der Regel konnte nicht geändert werden.');
define('CONFIGURATION','Konfiguration');
define('CONFIGURATION_TITLE','<span>OSE</span> Konfiguration');
define('CONFIGURATION_DESC','Übersicht der Konfiguration, um Einstellungen der Web Application Firewall zu ändern');
define('SEO_CONFIGURATION','SEO-Konfiguration');
define('SEO_CONFIGURATION_TITLE','SEO-<span>Konfiguration</span>');
define('SEO_CONFIGURATION_DESC','Konfigurationsseite für die  SEO-relevanten Einstellungen');
...
define('ANTISPAM_CONFIGURATION_DESC','Konfigurationsseite für die  Anti-Spam-relevanten Einstellungen');
define('EMAIL_CONFIGURATION','E-Mail-Konfiguration');
define('EMAIL_CONFIGURATION_TITLE','E-Mail-<span>Konfiguration</span>');
define('EMAIL_CONFIGURATION_DESC','Konfigurationsseite zum Bearbeiten von E-Mail-Vorlagen');
define('EMAIL_TEMPLATE_UPDATED_SUCCESS','E-Mail-Vorlage erfolgreich geändert.');
define('EMAIL_TEMPLATE_UPDATED_FAILED','Die E-Mail-Vorlage nicht geändert.');
define('EMAIL_ADMIN','Admin-E-Mail-Zuordnung');
define('EMAIL_ADMIN_TITLE','Administrator-E-Mail <span>Zuordnung</span>');
define('EMAIL_ADMIN_DESC','Lege fest, welcher Administrator welchen E-Mail-Alarm empfangen soll');
...
define('ANTIVIRUS_CONFIGURATION_DESC','Konfigurationsseite für die Virus Scanner-relevanten Einstellungen');
define('ANTIVIRUS','OSE Virus Scanner™');
define('ANTIVIRUS_TITLE','<span>OSE</span> Virus Scanner™');
define('ANTIVIRUS_DESC','Suche in deiner Webseite nach Viren / böswilligem Code');
...
define('YOUR_SYSTEM_IS_CLEAN','Glückwunsch, dein System ist sauber!');
define('VSREPORT','Scan-Berichte');
define('SCANREPORT_TITLE','OSE Virus Scan-<span>Berichte</span>');
define('SCANREPORT_DESC','Übersichtliche Anzeige infizierter Dateien');
define('VARIABLES','Variablen verwalten');
define('VARIABLES_TITLE','Variablen-<span>Verwaltung</span>');
define('VARIABLES_DESC','Übersichtliches Aktivieren/Deaktivieren von Variablen der Firewall');
...
//Since 2.3.0
define('FILE_UPLOAD_VALIDATION', 'Datei-Upload Validation');
?>