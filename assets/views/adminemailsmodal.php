			...
			<div class="modal-body">
				<form id='domains-form' class="form-horizontal group-border stripped" role="form">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input title="For example, www.domain.com" type="text" name="domain-address" value="" class="form-control" pattern="^(?:[-A-Za-z0-9]+\.)+[A-Za-z]{2,6}$" required>
						</div>
					</div>
					<input type="hidden" name="option" value="com_ose_firewall"> <input type="hidden" name="controller" value="adminemails"> <input type="hidden" name="action" value="saveDomain"> <input
						type="hidden" name="task" value="saveDomain"
					>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id='adminemails-form' class="form-horizontal group-border stripped" role="form">
					<div class="form-group">
						<label class="col-sm-4 control-label"><?php oLang::_('ADD_ADMIN_NAME'); ?></label>
						<div class="col-sm-8">
							<input type="text" name="admin-name" value="" class="form-control" required>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label"><?php oLang::_('ADD_ADMIN_EMAIL'); ?></label>
						<div class="col-sm-8">
							<input type="text" name="admin-email" value="" class="form-control" pattern="^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-zA-Z]{2,6}(?:\.[a-zA-Z]{2})?)$" required>
						</div>
					</div>
					<div class="form-group">
						<label for="status" class="col-sm-4 control-label"><?php oLang::_('ADD_ADMIN_STATUS'); ?></label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label for="website" class="col-sm-4 control-label"><?php oLang::_('ADD_ADMIN_DOMAIN'); ?></label>
						<div class="col-sm-8">
					...
					<input type="hidden" name="option" value="com_ose_firewall"> <input type="hidden" name="controller" value="adminemails"> <input type="hidden" name="action" value="saveAdmin"> <input type="hidden"
						name="task" value="saveAdmin">
