												...
												<div class="form-group">
													...
													<div class="col-xs-6">
														<div class="onoffswitch">
															<input type="checkbox" class="onoffswitch-checkbox" <?php
		echo ($vscansettings ['enabled'] == 1 && isset ( $vscansettings ['enabled'] )) ? " checked " : "";
	?> id="vscanonoffswitch"> <label class="onoffswitch-label" for="vscanonoffswitch"> <span class="onoffswitch-inner"></span> <span class="onoffswitch-switch"></span>
															</label>
														</div>
													</div>
												</div>
									...
									> <input type="hidden" name="schedule_type" value="1"> <input type="hidden" name="cloudbackuptype" value="1"> <input type="hidden" name="enabled"
										value="<?php
	
	echo ($vscansettings ['enabled'] == 1 && isset ( $vscansettings ['enabled'] )) ? 1 : 0;
	?>" id="vscanenabled"
									>
...
<div id="oseappcontainer">
	...
	<div class="row">
				<div class="panel panel-primary">
			<?php
	$image = OSE_FWURL . '/public/images/premium/scheduledtasks.png';
